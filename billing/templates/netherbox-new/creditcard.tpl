    ...
    <div class="col2half">
        <div class="internalpadding">
            ...
            <div class="control-group">
                ...
                <div class="controls"><input type="text" id="ccnumber" size="30" value="{$ccnumber}" autocomplete="off" class="newccinfo card-number" /></div>
            </div>
...
{/foreach}
            ...
            <div class="control-group">
                ...
                <div class="controls"><input type="text" id="cccvv" size="5" autocomplete="off" class="input-mini newccinfo" />&nbsp;<a href="#" onclick="window.open('{$BASE_PATH_IMG}/ccv.gif','','width=280,height=200,scrollbars=no,top=100,left=100');return false">{$LANG.creditcardcvvwhere}</a></div>
            </div>
